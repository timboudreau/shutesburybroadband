...
-Contracting with a local vendor to maintain the network 
...
Overall broadband internet will create many benefits and opportunities for people in Shutesbury that do not currently exist.  
...
-Gives residents opportunities to access educational and internet websites that require high download speeds
...
We believe an investment in broadband internet access in Shutesbury can pay for itself on a 20-30 year time horizon. This is the kind of investment government can make for its townspeople but commercial businesses with an eye to shorter-term profits aren't willing to fund.  
...
The decision of how to provide broadband for our community will be made by our town Selectboard who will consider recommendations from the broadband committee. 
Currently, we are considering both options. Much of the work to be done is identical whether or not the town opts to cast its lot with WiredWest - the same work needs to be done either way - so it is not necessary to answer this question immediately.
 ...
 * How do funds from the town and grant moneys find their way to the legal entity building the network. There are specific laws for monetary distribution . Example: (https://malegislature.gov/Laws/GeneralLaws/PartI/TitleVII/Chapter44/Section8))
...
The payback of any tax bonds raised by the town will follow two different modes: 
...
Any estimates are conjecture at this point, but the *best-case* scenario at the date of this writing (September, 2014) is two years from now. A project of this scope requires many complex decisions and finances as well as the involvement of private and public entities all working together. Our committee is dedicated to bringing broadband to the town in most expedient and cost effective manner. 

**How Much Will The Subscriber Fees Be?**
Any number is speculative at this point, but we believe with a plan similar to Leverett's, monthly subscriber fees will be between $60 -$80 per month for internet and unlimited local and long distance phone service.  For most people, that will be less than they are paying now for just phone service.
...
At some point we need to start doing the parts of this that cost money, which may require a "debt exclusion override" vote. This means that the town will vote to exclude the debt from counting toward the limitations placed on it by [Proposition 2 1/2](http://en.wikipedia.org/wiki/Proposition_2%C2%BD).  At present, the earliest that is likely to happen is the April 2015 town meeting.
...
Ownership is unclear at this point if we go with WiredWest. The town or Wired West may own the infrastructure. Management of the system might be performed by WiredWest or the work would be contracted to an ISP. One concern of not maintaining ownership is that the system could be sold to other third parties, such as private companies, in the case of bankruptcy. This is one of the important issues we are considering while exploring the two plans. 
...
**What About Wireless?**
Wireless internet is *line of sight*so it is affected by weather and is far slower than fiber-optic networking.  Wireless is an option for densely populated, flat, relatively unobstructed areas but it is not practical for Shutesbury whose terrain is hilly and sparsely populated.
